...
public class RegistroVisita extends GenericEntity{
	...
	private String dataVisitaSpv;
	
	//Cliente
	private String nomeCliente;
	private String praca;
	private Long diasReposicao;
	private String dataSpv;
	...
	public String getDataVisitaSpv() {
		return dataVisitaSpv;
	}

	public void setDataVisitaSpv(String dataVisitaSpv) {
	...
	public String getDataSpv() {
		return dataSpv;
	}

	public void setDataSpv(String dataSpv) {
	...
	public void setDataProximaVisita(String dataProximaVisita) {
