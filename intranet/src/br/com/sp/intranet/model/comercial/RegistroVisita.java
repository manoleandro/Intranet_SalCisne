...
public class RegistroVisita extends GenericEntity implements Comparable<RegistroVisita>{
...
private RegistroVisitaPK pk;
	...
	@Override
	public int compareTo(RegistroVisita o) {
		return this.getPk().getDataVisitaReal().compareTo(o.getPk().getDataVisitaReal());
	}
}