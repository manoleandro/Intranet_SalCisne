...
@FacesConverter(value = "pickListGenericConverter")
public class PickListGenericConverter implements Converter {
	...
	public Object getAsObject(FacesContext arg0, UIComponent arg1, String arg2) {
		...
		if (arg1 instanceof PickList) {
			...
			for (Iterator iterator = dl.getSource().iterator(); iterator.hasNext();) {
				...
				String id = (new StringBuilder()).append(((GenericEntity) o).getPrimaryKey()).toString();
				if (arg2.equals(id)) {
					ret = o;
					break;
				}
	...
	public String getAsString(FacesContext arg0, UIComponent arg1, Object arg2) {
		...
		if (arg2 instanceof GenericEntity)
			str = ((GenericEntity) arg2).getPrimaryKey().toString();
		return str;
	}
}
