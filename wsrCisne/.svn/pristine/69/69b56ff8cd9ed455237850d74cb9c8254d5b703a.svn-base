...
public class Cliente implements Serializable, Comparable<Cliente>{
	...
	public Cliente(Cliente cliente, Date dataVisita) {
		super();
		this.codZonaVendas = cliente.getCodZonaVendas();
		this.idUf = cliente.getIdUf();
		this.uf = cliente.getUf();
		this.idMunicipio = cliente.getIdMunicipio();
		this.nomeMunicipio = cliente.getNomeMunicipio();
		this.idCliente = cliente.getIdCliente();
		this.nomeFantasia = cliente.getNomeFantasia();
		this.razao = cliente.getRazao();
		this.idVendedor = cliente.getIdVendedor();
	...
	public int compareTo(Cliente o) {
		String nome = DataTypes.parseNull(this.getNomeFantasia());
		String nomeO = DataTypes.parseNull(o.getNomeFantasia());
		
		return nome.compareTo(nomeO);
	}
